...
void test_rpc_fail(void)
{
    ...
    TEST_ASSERT_EQUAL(0, test_rpc_method_fn_fake.call_count);
}
...
void test_rpc_call_not_json(void)
{
    ...
    on_rpc(NULL, status, &coap_rsp_code, NULL, (const uint8_t *) payload, strlen(payload), &grpc);
