...
typedef enum golioth_status (
    *glth_log_fn)(struct golioth_client *, const char *, const char *, golioth_set_cb_fn, void *);

static enum golioth_status golioth_log_drop(struct golioth_client *client,
                                            const char *tag,
