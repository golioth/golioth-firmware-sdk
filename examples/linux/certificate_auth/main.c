...
int main(void) {
    ...
    size_t client_key_len = read_file("certs/client.key", client_key_pem, sizeof(client_key_pem));
    size_t client_cert_len =
            read_file("certs/client.pem", client_cert_pem, sizeof(client_cert_pem));
    size_t root_ca_len = read_file("root_ca.pem", root_ca_pem, sizeof(root_ca_pem));
