...
Query the RPCs available on a device in the field
...
code of this sample application (i.e., `examples/zephyr/rpc-query`) and
type:

```console
$ west build -b qemu_x86 examples/zephyr/rpc-query
$ west build -t run
```
...
this sample application (i.e., `examples/zephyr/rpc-query`) and type:

```console
$ west build -b esp32_devkitc_wrover/esp32/procpu examples/zephyr/rpc-query
$ west flash
```
...
```console
$ west build -b nrf52840dk/nrf52840 examples/zephyr/rpc-query
$ west flash
```
...
```console
$ west build -b nrf9160dk/nrf9160/ns examples/zephyr/rpc-query
$ west flash
```
...
```console
$ west build -b rak5010/nrf52840 examples/zephyr/rpc-query
$ west flash
```
