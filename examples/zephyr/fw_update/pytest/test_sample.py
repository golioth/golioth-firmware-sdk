...
async def test_fw_update(shell, project, device, wifi_ssid, wifi_psk, fw_info, cohort, artifact):
    ...
    shell._device.readlines_until(
        regex=f".*Current firmware version: {fw_info['package']} - {fw_info['version']}.",
        timeout=120.0,
    )
